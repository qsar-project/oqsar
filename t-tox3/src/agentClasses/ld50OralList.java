...
public class ld50OralList extends ArrayList {
	public static ld50OralList GetLd50OralList(){
		Connection connection;
		ld50OralList list = new ld50OralList();
		try {
			// �������� ��������
			...
			CallableStatement Cstmt = connection.prepareCall("{call GetLd50OralList}");

			Cstmt.execute();
			ResultSet rs = Cstmt.getResultSet();
			ld50OralInfo info;
			while (rs.next()) {
				info = new ld50OralInfo();
